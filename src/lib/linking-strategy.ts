...
const TOPICAL_CLUSTERS = {
  labour: {
    name: 'نظام العمل',
    keywords: ['عمالي', 'عقد عمل', 'فصل تعسفي', 'مكافأة', 'حقوق عامل'],
    category: 'emali',
  },
  realEstate: {
    name: 'القانون العقاري',
    keywords: ['عقاري', 'عقار', 'ملكية', 'توثيق', 'سجل عقاري'],
    category: 'aqari',
  },
  commercial: {
    name: 'القانون التجاري',
    keywords: ['تجاري', 'استثمار', 'شركات', 'عقود تجارية'],
    category: 'tijari',
  },
  digital: {
    name: 'القانون الرقمي',
    keywords: ['رقمي', 'بيانات', 'إلكترونية', 'خصوصية', 'تجارة إلكترونية'],
    category: 'raqami',
  },
  civil: {
    name: 'القانون المدني',
    keywords: ['مدني', 'أحوال شخصية', 'حقوق', 'مسؤولية', 'عقود'],
    category: 'madani',
  },
}
