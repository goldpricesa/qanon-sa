...
const TOPICAL_CLUSTERS = {
  ...
  civil: {
    ...
    keywords: ['مدني', 'حقوق', 'مسؤولية', 'عقود', 'صحيفة دعوى', 'تعويض', 'نقض', 'تجارة إلكترونية', 'بيانات', 'خصوصية'],
    category: 'مدني',
  },
  personalStatus: {
  ...
  criminal: {
    ...
    keywords: ['جنائي', 'عقوبة', 'سرقة', 'سب وقذف', 'جرائم معلوماتية', 'عنف أسري', 'احتيال إلكتروني', 'ابتزاز رقمي'],
    category: 'جنائي',
  },
}
