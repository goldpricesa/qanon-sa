        ...
        <div className="max-w-2xl">
          <div className="flex items-center gap-3 mb-4">
            <CategoryBadge
              ...
              asLink={false}
            />
            <span className="inline-flex items-center gap-1.5 text-xs text-primary-300 bg-primary-900/50 rounded-full px-3 py-1">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              href={`/blog/${post.slug}`}
              className="inline-flex items-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-colors"
            >
              اقرأ المقال كاملاً
