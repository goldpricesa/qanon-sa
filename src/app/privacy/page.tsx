      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6">
          <EditorialNote
            ...
            note="تعكس هذه الصفحة السلوك الفعلي للموقع: أدوات التحليل لا تُحمَّل قبل موافقتك، أما الإعلانات فتظهر بوضع غير مخصص افتراضيًا ولا تستخدم ملفات ارتباط إعلانية إلا بعد موافقتك الصريحة."
          />
          ...
          <div className="prose prose-lg max-w-none text-stone-800 leading-relaxed">
            ...
            <ul>
              ...
              <li>تفضيلات الموافقة التي تحفظ محليًا في متصفحك لتذكر اختيارك للتحليلات والإعلانات.</li>
            ...
            <ul>
              ...
              <li>
                <strong>Google AdSense</strong> لعرض الإعلانات التي تدعم استمرارية المحتوى
                المجاني، وفق{' '}
                <a
                  href="https://policies.google.com/technologies/ads?hl=ar"
                  target="_blank"
            ...
            <p>
              أدوات التحليل لا تُحمَّل قبل القبول. أما خدمة الإعلانات فيُحمَّل سكربتها على
              صفحات الموقع لعرض إعلانات <strong>غير مخصصة</strong> افتراضيًا (وضع الموافقة
              Consent Mode على الرفض)، ولا تُستخدم ملفات الارتباط الإعلانية أو التخصيص إلا
              إذا وافقت صراحةً على فئة الإعلانات. تظل الحالة الافتراضية
              <strong> رفضًا </strong>
              لجميع الخيارات غير الضرورية.
            </p>
