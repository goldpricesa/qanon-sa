        ...
        <div className="space-y-6">
          ...
          <div className="prose prose-lg max-w-none text-stone-800 leading-relaxed">
            ...
            <ul>
              ...
              <li>تفضيلات الموافقة التي تحفظ محليًا في متصفحك لتذكر اختيارك للتحليلات.</li>
            ...
            <p>
              لا يتم تحميل هذه الخدمات قبل القبول، وتظل الحالة الافتراضية
              <strong> رفضًا </strong>
            ...
            <p>
              قد تستخدم خدمات التحليل ملفات تعريف ارتباط أو تقنيات مشابهة بعد
